    ...
    def __init__(self):
        ...
        while True:
                    if self.main:
                                ...
                                self.label2 = customtkinter.wCTkLabel(self.frame, text="Welcome to the cheat suite for cs:go made by ax11! I hope you will have fun using this client.", font=('', 14, 'normal'))
